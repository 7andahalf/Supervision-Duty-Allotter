...
<form action="view_saved_time_table_3.php" method="get">
...
<tr>
<td colspan="100%">
<h1><center><h3>LIST OF SUPERVISORS IN EVENING <?php echo $_GET['date']; ?></h3></center></h1>
</td>
</tr>
<tr>
...
$j_one = $j - 1;
	...
	if($ttoghsdgshdfsghdfsgh != '0' && $_GET['date'] == $data[3][$m_one] && $allo[$m_one]['e'][$j_one] == 'S'){
...
<tr>
<td colspan="100%">
<h1><center><h3>LIST OF RELEAVERS IN EVENING</h3></center></h1>
</td>
</tr>
...
$j_one = $j - 1;
	...
	$m_one = $m - 1;
	$ttoghsdgshdfsghdfsgh = $data[1][$m_one][0]+$data[1][$m_one][1]+$data[1][$m_one][2]+$data[1][$m_one][3];
	if($ttoghsdgshdfsghdfsgh != '0' && $_GET['date'] == $data[3][$m_one] && $allo[$m_one]['e'][$j_one] == 'R'){
